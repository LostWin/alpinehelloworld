...
Le site web vitrine a été conçu par l’équipe de développeurs de l’entreprise et les fichiers y relatifs se trouvent dans le repo suscité : [ https://github.com/Legeni07/projet_final.git ](https://github.com/Legeni07/projet_final_.git) . Il est de votre responsabilité de conteneuriser cette application tout en permettant la saisie des différentes URL des applications (Odoo et pgadmin) par le biais des variables d’environnement. 
...
Les serveurs nécessaires sont les suivants :
        ...
        1) **Serveur 1** : Jenkins ( https://github.com/Legeni07/devops_keyce/tree/main/jenkins-install)
        2) **Serveur 2** : Applications web site vitrine + pgadmin4 
        3) **Serveur 3** : Application Odoo 
